...
## Background 
> I have searched the internet for a simple (Open Source) Analytics Platform that can integrated with a many data sources and MongoDb in particular. Also important to me was interactivity and ability to use the platform for embedded analytics into a web application. I found Metabase to tick all the boxes and their pricing and open source offering made this even more attractive. 

> Having played around with docker, and am comfortable enough to run and manage containers. I decided to test Metabase, look around using a local version and it because apparent that l needed a production version after interrogating some data from my MongoDb and answering a few questions. to not lose any of the work i had done while exploring. 
